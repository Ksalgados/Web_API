<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="dashboard_vendedor.aspx.cs" Inherits="MUSICPRO_APP.Vendedor.dashboard_vendedor" %>
            ...
            <div>
                ...
                <div class="nav_list">
                   <a href="Productos.aspx" class="nav_link"><i class='bx bx-box nav_icon'></i><span
                    ...
                    <a href="Pagos.aspx" class="nav_link"><i class='bx bx-message-square-detail nav_icon'></i><span
                            class="nav_name">Pagos</span> </a>
                </div>
            </div>
