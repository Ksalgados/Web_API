<%@ Page Title="Login" Language="C#" AutoEventWireup="true" CodeBehind="login.aspx.cs"  Inherits="MUSICPRO_APP.login" %>
...
<head runat="server">
    ...
    <style>
        ...
        body {
            background: linear-gradient(rgba(246, 247, 249, 0.2), rgba(246, 247, 249, 0.2)), url(https://latinwmg.com/wp-content/uploads/2019/05/rock_en_espanol.jpg) no-repeat center center fixed;
        ...
        .frame {
            height: 575px;
            width: 430px;
            background: linear-gradient(rgba(35, 43, 85, 0.75), rgba(35, 43, 85, 0.95)), url(https://latinwmg.com/wp-content/uploads/2019/05/rock_en_espanol.jpg) no-repeat center center;
            background-size: cover;
            margin-left: auto;
            margin-right: auto;
        ...
        <div class="frame">
            ...
            <div ng-app ng-init="checked = false">
                ...
                <form class="form-signin" action="" method="post" name="form">
                    ...
                    <div class="btn-animate"><a class="btn-signin" style="color: #ffffff">Sign in</a> </div>
                </form>
                ...
                <form class="form-signup" action="" method="post" name="form">
                    ...
                    <a ng-click="checked = !checked" class="btn-signup">Registrarse</a> </form>
                <div class="success">
